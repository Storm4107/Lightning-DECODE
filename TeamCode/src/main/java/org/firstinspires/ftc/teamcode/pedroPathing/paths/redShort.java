...
public class redShort {
    ...
    public static Pose shootPose = new Pose(92.42131979695432, 90.9238578680203, Math.toRadians(-135));
    public static Pose middlePose = new Pose(134.0203045685279, 64.56852791878173);
    public static Pose middleControl = new Pose(81.13705583756345, 60.30964467005076);
    public static Pose gatePose = new Pose(123, 82 , Math.toRadians(0));
    public static Pose gateControlPose = new Pose(105, 68, Math.toRadians(0));
    public static Pose frontPose1 = new Pose(110, 96, Math.toRadians(0));
    public static Pose frontPose = new Pose(156, 82, Math.toRadians(0));
    ...
    public static PathChain pickupFront() {
        return new PathBuilder(follower)
                ...
                .setConstantHeadingInterpolation( frontPose.getHeading())
                .build();
    }
