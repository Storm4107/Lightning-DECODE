...
public class MidShotCommand extends CommandBase {
    ...
    public MidShotCommand(LightsSub lightsSub, ShooterSub shooterSub, IndexerSub indexersub, IntakeSub intakeSub){
        lights = lightsSub;
        shooter = shooterSub;
        indexer = indexersub;
        intake = intakeSub;
    ...
    public void initialize() {
        ...
        shooter.setState(ShooterSub.shooterStates.MIDSHOT);
