...
public class ShortShotCommand extends CommandBase {
    ...
    public ShortShotCommand(LightsSub lightsSub, ShooterSub shooterSub, IndexerSub indexersub, IntakeSub intakeSub){
        lights = lightsSub;
        shooter = shooterSub;
        indexer = indexersub;
        intake = intakeSub;
    ...
    public void initialize() {
        ...
        shooter.setState(ShooterSub.shooterStates.SHORTSHOT);
